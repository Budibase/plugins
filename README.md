...
| [Geolocation Field](https://github.com/andz-bb/budibase-component-geolocation/blob/master/README.md) | A form field with a button that gets the user's location | Form Input | [Andrew Thompson](https://github.com/andz-bb) | `form` `location` `gps` |
