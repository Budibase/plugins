...
| [Kanban Board](https://github.com/ConorWebb96/bb-kanban-draggable) | A Budibase component which create a kanban board for moving cards between statues quickly. | Component type | [Conor Webb](https://github.com/ConorWebb96) | `board`, `pipeline`, `container` |
