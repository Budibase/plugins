...
| [Gradient header](https://github.com/joebudi/budibase-component-gradient-header) | The gradient header sits on top of your screens and makes them look a little prettier | Header component | [Joe Johnston](https://github.com/joebudi) | `image` `gradient` `emoji` |
