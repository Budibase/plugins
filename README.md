...
| [Budibase File Upload](https://github.com/chungchunwang/Budibase-File-Upload)| A Budibase form component that allows you to upload file and store them within a string in your database. The file is viewable and downloadable. This allows you store your files inside of your SQL or internal DB without using the default solution of a url to MinIO. | Component | [Chungchun Wang](https://github.com/chungchunwang) | `files` `DB` `form` |
