...
* [Datasources and APIs](#datasources-and-apis)
...
| [Crypto Functions](https://github.com/CSLTech/budibase-crypto) | Stub datasource around crypto functions | Datasource | [Michaël St-Georges](https://github.com/CSLTech) | `crypto` `sign` `encrypt` |
...
Title | Description | Type | Author | Tags |
|---|---|---|---|---|
| [Accordion](https://docs.budibase.com/docs/accordion) | **Deprecated:** [now natively available in Budibase](https://docs.budibase.com/docs/accordion) | Component | [Andrew Thompson](https://github.com/andz-bb) | `layout` `container` `accordion` |
...
| [Count Down Timer](https://github.com/JayP718/Countdown_Timer) | A timer which counts down (days/min/secs) to a certain date time. | Component | [Jay P.](https://github.com/JayP718) | `Timer` `Form` |
...
| [Currency Input](https://github.com/MarceloArraes/budibase-currency-input) | A dynamic formatted currency input that saves as a number | Component | [Marcelo Arraes](https://github.com/MarceloArraes) | `input` `currency` `form` |
...
| [FullCalendar](https://github.com/ConorWebb96/budibase-fullcalendar) | It's a component to implement fullcalendar in your budibase. | Component | [Pixel Infinito](https://github.com/pixelinfinito) |  `Calendar`  `Calendar events`
...
| [Star Rating](https://docs.budibase.com/docs/rating) | **Deprecated:** [now natively available in Budibase](https://docs.budibase.com/docs/rating) | Form Input | [Andrew Thompson](https://github.com/andz-bb) | `form` `input` |
